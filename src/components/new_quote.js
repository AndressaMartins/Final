...
import {StyleSheet, View, Dimensions, Text, TextInput, TouchableOpacity, Button} from 'react-native';
        ...
        return (
            <View style={{flex: 1, backgroundColor: '#fff'}}>
                <View style={{flex:1, paddingLeft:10, paddingRight:10}}>
                    ...
                    />
                     <Camera visible={this.state.isCameraVisible} close={() => this.setState({isCameraVisible:false})} callback={(url) => this.setState({image: url})}
                    />
                </View>
                <Button title='camera' onPress={() => this.setState({isCameraVisible: true})}
                    />
